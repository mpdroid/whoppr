...
import static com.whoppr.monolith.TestUtils.buildTestOrder;
...
public class IntegrationTestBase {
  ...
  protected List<MenuItem> createTestMenuItems() throws Exception {
    ...
    List<MenuItem> menuItems = TestUtils.buildTestMenuItems();
  ...
  protected Customer createTestCustomer() throws Exception {
    ...
    Customer customer = TestUtils.buildTestCustomer();
